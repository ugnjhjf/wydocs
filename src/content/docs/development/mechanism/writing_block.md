...
right click to put a stack of fu (like pedestal, but not only 1 size), shift right click to edit and open a gui.

also, add a new recipe to clear the content of fu, for itemstack merge.
